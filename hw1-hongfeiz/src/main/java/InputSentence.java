...
public class InputSentence extends Annotation {
   ...
   * @generated */
  protected InputSentence() {/* intentionally empty block */}
  ...
  */  
  ...
  /** getter for id - gets Id of each sentence
   * @generated
   * @return value of the feature 
   */
  public String getId() {
    if (InputSentence_Type.featOkTst && ((InputSentence_Type)jcasType).casFeat_id == null)
      jcasType.jcas.throwFeatMissing("id", "InputSentence");
    return jcasType.ll_cas.ll_getStringValue(addr, ((InputSentence_Type)jcasType).casFeatCode_id);}
    
  /** setter for id - sets Id of each sentence 
   * @generated
  ...
  public void setId(String v) {
    if (InputSentence_Type.featOkTst && ((InputSentence_Type)jcasType).casFeat_id == null)
      jcasType.jcas.throwFeatMissing("id", "InputSentence");
    jcasType.ll_cas.ll_setStringValue(addr, ((InputSentence_Type)jcasType).casFeatCode_id, v);}    
   
    
  //*--------------*
  //* Feature: text

  /** getter for text - gets Text of each sentence
   * @generated
   * @return value of the feature 
   */
  public String getText() {
    if (InputSentence_Type.featOkTst && ((InputSentence_Type)jcasType).casFeat_text == null)
      jcasType.jcas.throwFeatMissing("text", "InputSentence");
    return jcasType.ll_cas.ll_getStringValue(addr, ((InputSentence_Type)jcasType).casFeatCode_text);}
    
  /** setter for text - sets Text of each sentence 
   * @generated
   * @param v value to set into the feature 
   */
