...
public class InputSentence_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("InputSentence");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "InputSentence");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "InputSentence");
